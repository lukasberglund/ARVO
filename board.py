...
=======
    ...
    def is_open(self,x1,y1,x2,y2):
        return self.sub_boads[x1][y1].is_open(x2,y2)
    ...
    def play_move(self,x1,y1,x2,y2):
        ...
        if self.sub_boards[x1][y1].is_won:
            self.sub_boards[x1][y1] = self.sub_boards[x1][y1].winner
    ...
    def col_won(self,piece):
        ...
        while not won or col < 3:
            won = self.sub_boads[0][col] == piece and self.sub_boads[1[col] == piece and self.sub_boads[2][col] == piece
            col = col + 1
        return won
    ...
    def row_won(self,piece):
        ...
        while not won or row < 3:
            return self.sub_boads[row][0] == piece and self.sub_boads[row[1] == piece and self.sub_boads[row][2] == piece
            row = row + 1
        return won

    def diagon_won(self,piece):
        if self.sub_boads[0]0] == piece and self.sub_boads[1][1] == piece and self.sub_boads[2][2] == piece:
            return True
